...
move_uploaded_file($archivo_tmp, "_archivos/portafolios/" . $archivo);

												
$consulta = mysql_query("SELECT email FROM modelos WHERE email='".$email."'");
						
if(mysql_num_rows($consulta) > 0) echo '<br><br><br><br><br><p align="center">Este email ya se encuentra registrado<br><br><a href="galeria-imagenes.php">Volver</a></p>';
						
else {
	
$sentencia="INSERT INTO modelos (nombre, apellido, pais, estado, ciudad, email, telfijo, telcel) VALUES('$nombre', '$apellido', '$pais', '$estado', '$ciudad', '$email', '$telfijo', '$telcel')";
...
$asunto           = "Una modelo ha contactado con nosotros";

$mensaje          = "Una modelo ha contactado con nosotros".'<br>'.$nombre.'<br>'.$apellido.'<br>'.$pais.'<br>'.$estado.'<br>'.$ciudad.'<br>'.$email.'<br>'.$telfijo.'<br>'.$telcel.'<br><br>'.'Curriculum adjunto en: http://es.byvergara.com/_archivos/portafolios/'.basename($archivo);
...
session_destroy();
										...
										echo '<br><br><br><br><br><p align="center">El archivo seleccionado tiene un formato o peso invalido<br><br><a href="galeria-imagenes.php">Volver</a></p>';
									} 
								
								}
								else {
									echo '<br><br><br><br><br><p align="center">Introduzca un telefono movil valido<br><br><a href="galeria-imagenes.php">Volver</a></p>';
								}
							
							}
							else {
								echo '<br><br><br><br><br><p align="center">Introduzca un telefono fijo valido<br><br><a href="galeria-imagenes.php">Volver</a></p>';
							}
				
						}
						else {
							echo '<br><br><br><br><br><p align="center">Introduzca una ciudad valida<br><br><a href="galeria-imagenes.php">Volver</a></p>';
						}
				
					}
					else {
						echo '<br><br><br><br><br><p align="center">Introduzca un estado valido<br><br><a href="galeria-imagenes.php">Volver</a></p>';
					}
				
				}
				else {
					echo '<br><br><br><br><br><p align="center">Introduzca un pais valido<br><br><a href="galeria-imagenes.php">Volver</a></p>';
				}

		}
		else {
			echo '<br><br><br><br><br><p align="center">Introduzca un correo valido<br><br><a href="galeria-imagenes.php">Volver</a></p>'; 
		}
	
}
else {
	echo '<br><br><br><br><br><p align="center">Introduzca un nombre o apellido valido<br><br><a href="galeria-imagenes.php">Volver</a></p>';
}
