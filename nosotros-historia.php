...
<br>
	<div class="slider2"> 
   		...
   		<ul class="bxslider">
  			<li><img src="img/slider/historia/1.png" title="#"/></li>
        	<li><img src="img/slider/historia/2.png" title="#"/></li>
        	<li><img src="img/slider/historia/3.png" title="#"/></li>
		</ul>
    ...
    <div class="nosotros-menu">
    	...
    	<div class="nosotros-menu1">
        	
            <h4 align="justify">Nuestra historia</h4>
        	<p align="justify">Conoce a Vergara desde sus primeros años ofreciendote lo mejor.</p>
            <p><a href="nosotros-historia.php">Mas informacion..</a></p> 
        
        </div>  
        
        <div class="nosotros-menu1">
        	
            <h4 align="justify">Nuestras tiendas</h4>
        	<p align="justify">Conoce mas acerca de la compañía que te brinda un mejor futuro.</p>
            <p><a href="nosotros-tiendas.php">Mas informacion..</a></p>
        
        </div>
        
        <div class="nosotros-menu1">
        	
            <h4 align="justify">Programa VIP</h4>
        	<p align="justify">Conoce más acerca de nuestro programa para clientes exclusivos.</p>
            <p><a href="_vip1.php">Mas informacion..</a></p> 
