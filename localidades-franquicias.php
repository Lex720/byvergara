...
<br>
	...
	<h2 align="center">Franquicias y distribuidores</h2>
    ...
    <div class="localidades">
		...
		<br><h2 align="center">Franquicias</h2>

    	<ul id="og-grid" class="og-grid">
            
            <li>
            	<div class="franquicias">
                	<h3>C.C Plaza Mayor</h3>
                    <p>C. C. Plaza Mayor, Nivel 1 Edificio N.6, Local 6B-114.<br>Lechería. Estado. Anzoátegui.</p>
            		<a href="#" onclick="lugar1()">Ver ubicación</a>
            	</div>
            </li>
            
            <li>
            	<div class="franquicias">
                	<h3>C.C Vía Veneto</h3>
                    <p>C. C. Vía Veneto, Nivel Florencia F-23, Naguanagua.<br>Valencia, Estado. Carabobo.</p>
            		<a href="#" onclick="lugar2()">Ver ubicación</a>
            	</div>
            </li>
            ...
            <li>
            	<div class="franquicias">
                	<h3>Albrook Mall</h3>
                    <p>Albrook Mall, pasillo del pinguino, segundo nivel, PA-M1.<br>Panamá.</p>
            		<a href="#" onclick="lugar3()">Ver ubicación</a>
            	</div>
            </li>
  
		</ul>

		<br><h2 align="center">Distribuidores</h2>
		...
		<ul id="og-grid" class="og-grid">
			...
			<li>
            	<div class="franquicias">
            		<h3>VENEZUELA</h3>
            		<p>
                    <!--Calle Almendrones, cruce con Av. Anzoátegui. Lechería. Estado. Anzoátegui.<br>-->
                    Contacto:<br> (058) 0281 2810014<br> info@byvergara.com
                    </p>
                    <a href="#" onclick="lugarA()">Ver ubicacion</a>
            	</div>
            </li>
            ...
            <li>
            	<div class="franquicias">
            		...
            		<a href="#" onclick="lugarB()">Ver ubicación</a>
            	</div>
            </li>
            ...
            <li>
            	<div class="franquicias">
            		...
            		<a href="#" onclick="lugarC()">Ver ubicación</a>
            	</div>
            </li>
            ...
            <li>
            	<div class="franquicias">
                	<h3>BOLIVIA:</h3>
                    <p>
                    <!--Santa Cruz de la Sierra, Centro Comercial Norte, pasillo 15 local #455.<br>-->
                    Contacto:<br> (591) 721 75327<br> bolivia@byvergara.com
                    </p>
            		<a href="#" onclick="lugarD()">Ver ubicación</a>
            	</div>
            </li>
        ...
        <!--<p>Puedes visitar también nuestra sección de <a href="localidades-distribuidores.php">Distribuidores</a>.</p>-->
