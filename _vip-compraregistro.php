...
?>
    ...
    <br>
    	...
    	<h1 align="center">Compras con tarjetas VIP</h1>
        
        <p align="center">Ingresa la información de la compra para que sea registrada en el sistema.</p>
        
        <br>
        
        	<form method="post" action="_vip-compraregistro-insert.php">
            	
			<p align="center">
            <input class="formulario" id="codigo_tarjeta" size="45%" type="text" name="codigo_tarjeta" placeholder="Codigo de tarjeta" required="required"></input>
            </p>
            ...
            <p align="center">
            <input class="formulario" id="fecha" size="45%" type="text" name="fecha" placeholder="Fecha: dd/mm/aaaa" required="required"></input>
            </p>
            
            <p align="center">
            <input class="formulario" id="monto" size="45%" type="text" name="monto" placeholder="Monto de compra (sin descuento): 000000.00" required="required"></input>
            </p>
