...
<div class="main">
	...
	<div class="vip1-text">
    	...
    	<h2 align="center">BENEFICIOS TARJETA VERGARA VIP GOLD</h2>
        
        <br><br>
        
		<h3>Descuento en todas tus compras</h3>
        <p align="justify">
        Gracias a la tarjeta VERGARA VIP GOLD, todas tus compras serán recompensadas. Presenta tu Tarjeta cada vez que realices una compra en VERGARA y recibirás un descuento de 10%*. También recibirás tips de moda y promociones especiales a lo largo del año.
        </p>
        
        <br>
        
        <h3>Obsequio de Bienvenida</h3>
        <p align="justify"> 
        Junto con tu tarjeta VIP VERGARA recibirás una Gift Card Pre-Pagada**.
        </p>
        ...
        <p align="justify">
		El día de tu cumpleaños tus compras tienen un 5% de descuento adicional y al asignado a tu tarjeta.
        </p>
        ...
        <p align="justify">
        Benefíciate durante todo el año de promociones exclusivas sólo para titulares.
        </p>
        
        <br>

        <p align="justify">
        (*) No acumulable a otros descuentos y/o promociones.<br>
		(**) La Gift Card será la de menor denominación.<br>
		Válido en tiendas VERGARA en Venezuela.
        </p>
        
        <br><br>
        
        <h2 align="center">BENEFICIOS TARJETA VERGARA VIP PLATINUM</h2>
        
        <br><br>
        
		<h3>Descuento en todas tus compras</h3>
        <p align="justify">
        Gracias a la tarjeta VERGARA VIP PLATINUM, todas tus compras serán recompensadas. Presenta tu Tarjeta cada vez que realices una compra en VERGARA y recibirás un descuento de 20%*. También recibirás tips de moda y promociones especiales a lo largo del año.
        </p>
        ...
        <p align="justify">
        (*) No acumulable a otros descuentos y/o promociones.<br>
		(**) La Gift Card será la de mayor denominación.<br>
		Válido en tiendas VERGARA en Venezuela.
        </p>
