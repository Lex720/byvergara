...
<div class="main">
    ...
    <br>
    	...
    	<h1 align="center">Programa VIP VERGARA</h1>
        
        <p>Esta sección es exclusiva para franquiciados VERGARA.</p>
        
        <br>
        
        <div class="actualizacion1">
            
            <p align="center">Ingresa tus datos para acceder al sistema:</p>
            
            <p>&nbsp;</p>
        
        	<form method="post" action="_vip-acceder-in.php">
            	
			<p><input class="formulario" id="usuario" size="45%" type="text" name="usuario" placeholder="Usuario" required="required"></input></p>
			<p><input class="formulario" id="pass" size="45%" type="password" name="pass" placeholder="Password" required="required"></input></p>
