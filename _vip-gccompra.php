...
?>
    ...
    <br>
    	...
    	<h1 align="center">Compras con Gift Cards</h1>
        
        <p align="center">Ingresa la información de la compra para registrarla.</p>
        
        <br>
        
        	<form method="post" action="_vip-gccompra-insert.php">
            ...
            <p align="center">
            <input class="formulario" id="nombre" size="45%" type="text" name="nombre" placeholder="Nombre del cliente" required="required"></input>
            </p>
            
            <p align="center">
            <input class="formulario" id="apellido" size="45%" type="text" name="apellido" placeholder="Apellido del cliente" required="required"></input>
            </p>
            ...
            <p align="center">
            <input class="formulario" id="fecha_compra" size="45%" type="text" name="fecha_compra" placeholder="Fecha de compra: dd/mm/aaaa" required="required"></input>
            </p>
            
            <p align="center">
            <input class="formulario" id="status" size="45%" type="hidden" name="status" value="canjeada" placeholder="" required="required"></input>
            </p>
