...
header("Content-Disposition: attachment; filename=Reporte_Giftcards.html");
...
echo"<tr><th align=center colspan=5><h2>Listado de GiftCards</h2></th></tr>";
echo"<tr>
...
$consulta = $db->prepare("SELECT `codigo`, `tipo`, `fecha_entrega`, `tienda`, `status` FROM giftcards ORDER BY codigo");
$consulta->execute();
