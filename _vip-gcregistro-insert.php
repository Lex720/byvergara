...
if(is_numeric($codigo)) {
	...
	if(preg_match("/([0-9]{2})\/([0-9]{2})\/([0-9]{4})/", $fecha_entrega)) {
		...
		if($num_filas > 0) {
			...
			echo '<br><br><br><br><br><p align="center">Este codigo ya se encuentra registrado<br><br><a id="buscar2" href="_vip-gcregistro.php">Volver</a></p><br><br><br><br><br>';
		}
								
		else {				
		
			$insert = $db->query("INSERT INTO giftcards (codigo, tipo, fecha_entrega, tienda, status) VALUES ('$codigo', '$tipo', '$fecha_entrega', '$tienda', '$status');");
			
			print "<meta http-equiv=Refresh content=\"5 ; url=_vip-gcregistro.php\">";
			
			echo '<p align="center">'.
				 '<br><br><br><br><br>'.
				 'La giftcard ha sido registrado con exito.'.
				 '<br><br>'.
				 '<a id="buscar2" href="_vip-gcregistro.php">Continuar</a>'.
				 '<br><br><br><br><br>'.
				 '</p>';
		}
		...
		echo '<br><br><br><br><br><p align="center">Introduzca una fecha con formato valido<br><br><a id="buscar2" href="_vip-gcregistro.php">Volver</a></p><br><br><br><br><br>';
	}
			
}
else {
	echo '<br><br><br><br><br><p align="center">Introduzca un numero de codigo (serial) valido<br><br><a id="buscar2" href="_vip-gcregistro.php">Volver</a></p><br><br><br><br><br>';
}
