...
var Navigation = {
	...
	init: function() {
		...
		// Home 
		$('nav2 .home').on('click', function() {
			$('#book').turn('page', 1);
		});
	
		// Zoom Original
		$('nav2 .zoom_original').click(function() {
			current_zoom_step = 0;
		...
		// Zoom Auto
		$('nav2 .zoom_auto').on('click', function() {
			Book.zoom_auto();
			Book.book_position();
		});

		// Zoom In
		$('nav2 .zoom_in').on('click', function() {
		...
		// Zoom Out
		$('nav2 .zoom_out').on('click', function() {
			if ( current_zoom_step > -zoom_steps ) {
				Book.zoom_out();
				Book.book_position();
			}
		...
		// All Pages
		$('nav2 .show_all').on('click', function() {
			$('#all_pages').
				addClass('active').
				css('opacity', 0).
