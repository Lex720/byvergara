...
?>
    ...
    <br>
    	...
    	<h1 align="center">Registro de Tarjetas VIP</h1>
        
        <p align="center">Ingresa la información de la tarjeta Gold/Platinum para registrarla.</p>
        
        <br>
        
        	<form method="post" action="_vip-tarjetaregistro-insert.php">
            ...
            <input class="formulario" id="platinum" type="radio" name="tipo" value="1" checked = "checked">Platinum</input>&nbsp;
            <input class="formulario" id="gold" type="radio" name="tipo" value="2">Gold</input>
            </p>
            ...
            <p align="center">
            <input class="formulario" id="status" size="45%" type="hidden" name="status" value="inactiva" placeholder="Status" required="required"></input>
            </p>
